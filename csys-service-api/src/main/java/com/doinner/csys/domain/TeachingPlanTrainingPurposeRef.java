...
/**
 * 教学计划训练目的支撑毕业要求实体（type2 第二节）。
 * <p>
 * 每条记录表示一条训练目的绑定一个毕业要求，结构对标 {@link TeachingPlanTaskBackgroundRef}。
 */
public class TeachingPlanTrainingPurposeRef extends AbstractDoinnerLogicalDelBaseEntity {
