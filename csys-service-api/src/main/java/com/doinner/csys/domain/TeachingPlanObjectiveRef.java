...
/**
 * 教学计划目标支撑毕业要求实体
 * 每条记录表示一条目标内容绑定一个当前tab下允许的毕业要求
 */
public class TeachingPlanObjectiveRef extends AbstractDoinnerLogicalDelBaseEntity {
    ...
    /**
     * 培养方案调用课程毕业要求关联ID，优先关联t_csys_scheme_course_ref_graduation.id
     */
    ...
    /**
     * 绑定来源：scheme_course_ref或course_ref_graduation
     */
